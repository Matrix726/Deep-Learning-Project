...
def query_gpt(text_list, api_key, max_tokens=30, temperature=0, max_try_num=10, model="gemini-1.0-pro"):
    genai.configure(api_key=api_key)
    result_list = []
    for prompts in tqdm(text_list):
        curr_try_num = 0
            ...
            try:
                ...
                response = model.generate_content(
                    ...
                    generation_config=genai.types.GenerationConfig(
                        max_output_tokens=max_tokens,  # Limit output to 100 tokens
